  ...
  const portalOptions = [
    {
      to: '/login/admin',
      title: 'Admin Portal',
      description: 'Manage emplyoees, departments, payroll, and system configurations.',
      icon: ShieldIcon
    },
    {
      to: '/login/employee',
                ...
                portalOptions.map((portal)=>(
                  ...
                  transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50'>
                    ...
                    <div className='relative z-10 flex items-center justify-between gap-4 sm:gap-5'>
                      <h3 className='text-lg text-slate-800 group-hover:translate-x-1 transition-all duration-300'>
                        {portal.title}
