    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md animate-fade-in ">
          ...
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl font-medium font-zinc-800 ">
              {title}
            </h1>
          ...
          {error && (
            <div
              className="mb-6 p-4 bg-rose-50 border border-rose-200 text-rose-700
               text-sm rounded-xl flx items-start gap-3"
            >
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            className="w-full py-3 bg-linear-to-r text-white
            font-semibold text-sm rounded-md
            from-indigo-600 to-indigo-500 hover:from-indigo-700
            hover:to-indigo-600 disabled:opacity-50 transition-all duration-200
